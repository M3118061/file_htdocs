<html> 
<head>     
	<title>Form Enkripsi Vigenere</title>
	<meta charset="UTF-8">
...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="enkripsi_act.php" method="post">
					<div class="wrap-input100 validate-input m-b-26">
						<span class="label-input100">Plainteks</span>
						<input class="input100" type="text" name="plain" placeholder="Input Plainteks">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18">
						<span class="label-input100">Key</span>
						<input class="input100" type="text" name="kunci" placeholder="Input Key">
						<span class="focus-input100"></span>
					</div>
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit">Enkripsi</button>
						&nbsp;
