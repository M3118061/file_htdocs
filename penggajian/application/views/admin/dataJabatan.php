  ...
  <table class="table table-bordered table-striped mt-2">
	...
	<?php $no=1; foreach($jabatan as $j) :?>
		<tr>
			...
			<td>
				<center>
					<a class="btn btn-sm btn-primary" href="<?php echo base_url ('admin/dataJabatan/edit_data/'.$j->id_jabatan) ?>"><i class="fas fa-edit"></i></a>
					<a onclick="return confirm('Yakin Hapus?')"class="btn btn-sm btn-danger" href="<?php echo base_url ('admin/dataJabatan/delete/'.$j->id_jabatan) ?>"><i class="fas fa-trash"></i></a>
				</center>
			</td>
		</tr>
	<?php endforeach; ?>
